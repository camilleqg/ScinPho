...
#def sim(events, noise, scramble, verbose = False, eventscale=1, noisescale=1, spacesigma=0.00021233045007200478, start_time=-1, start_x=-1, start_y=-1, dataSaveID = None, file=None):
    ...
    parser.add_argument("-spd", "--spacedensity", type = str, default = '1', help="Density of events in space, scales the detector sidelength, no leading zeroes")
    parser.add_argument("-td", "--timedensity", type = str, default = '1', help = "Density of events in time, from 0-1, needs to be a string with no leading zeroes")
